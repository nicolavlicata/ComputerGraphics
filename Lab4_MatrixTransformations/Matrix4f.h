...
public:
    ...
    void InitRotation(float x, float y, float z){
        ...
        rz.Set(1,0, sin(z)*-1); rz.Set(1,1,cos(z)); rz.Set(1,2,0);  rz.Set(1,3,0);
        ...
        rx.Set(2,0, 0);         rx.Set(2,1,sin(x)*-1);  rx.Set(2,2,cos(x));  rx.Set(2,3,0);
        rx.Set(3,0, 0);         rx.Set(3,1,0);          rx.Set(3,2,0);       rx.Set(3,3,1);

        ry.Set(0,0, cos(y));    ry.Set(0,1,0);      ry.Set(0,2,sin(y)*-1);  ry.Set(0,3,0); 
